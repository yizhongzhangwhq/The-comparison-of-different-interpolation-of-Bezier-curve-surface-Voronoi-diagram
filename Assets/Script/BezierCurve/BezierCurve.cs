...
{
    // a look up table for factorials. Capped to 15.
    ...
    public static Vector3 Point3(float t, List<Vector3> controlPoints)
    {
        ...
        if (N > 15)
        {
            Debug.Log("More than 15 control points.");
            controlPoints.RemoveRange(15, controlPoints.Count - 15);
        }
      ...
      float interval = 0.01f)
    {
        ...
        if (N > 15)
        {
            Debug.Log("The maximum control points allowed is 15.");
            controlPoints.RemoveRange(15, controlPoints.Count - 15);
        }
